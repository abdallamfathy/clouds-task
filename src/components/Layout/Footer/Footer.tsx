...
const Footer: React.FC = () => {
  return (
    <div className='flex flex-col bg-gray-50 2xl:px-40 xl:px-20 lg:px-10 px-5 lg:pt-24 py-5 mt-20 '>
        <div className='flex justify-between items-center w-full border-b border-gray-200 pb-20'>
                <div className='w-1/2 flex flex-col gap-6'>
                    <img src={logo} alt="logo" className='w-36' />
                    <p className='text-gray-400 w-96 leading-relaxed text-sm'>"On the other hand, we denounce with righteous indignation and dislike who are so beguiled and demoralized by the charms of pleasure of the moment"</p>
                </div>
                <div className='w-1/2 flex justify-end 2xl:gap-40 xl:gap-36 lg:gap-28 md:gap-20 self-end text-sm'>
                    <div className=' flex flex-col  gap-2'>
                        ...
                        <p className='hover:underline cursor-pointer hover:underline-offset-4 text-gray-400 text-sm'>Feedback</p>
                    ...
                    <div className=' flex flex-col  gap-2'>
                        ...
                        <p className='hover:underline cursor-pointer hover:underline-offset-4 text-gray-400 text-sm'>Copyright</p>
                    ...
                    <div className='    flex flex-col  gap-2'> 
                        ...
                        <p className='hover:underline cursor-pointer hover:underline-offset-4 text-gray-400 text-sm'>Youtube</p>

                    </div>
                </div>
        </div>

        <div className='flex justify-between items-center text-gray-400 pt-10 pb-5'>
